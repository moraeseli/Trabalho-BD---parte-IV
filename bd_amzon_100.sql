...
DROP SEQUENCE IF EXISTS endereco_seq CASCADE;
...
CREATE SEQUENCE endereco_seq START WITH 101;
...
ALTER TABLE CHAT     DROP CONSTRAINT FK_CHAT_LOJA;
ALTER TABLE CHAT     ADD  CONSTRAINT FK_CHAT_LOJA     FOREIGN KEY (fk_LOJA) REFERENCES LOJA(ID_Loja) ON DELETE SET NULL;

ALTER TABLE PRODUTO  DROP CONSTRAINT FK_PROD_LOJA;
ALTER TABLE PRODUTO  ADD  CONSTRAINT FK_PROD_LOJA     FOREIGN KEY (fk_LOJA) REFERENCES LOJA(ID_Loja) ON DELETE CASCADE;

ALTER TABLE AVALIACAO DROP CONSTRAINT FK_AV_LOJA;
ALTER TABLE AVALIACAO ADD  CONSTRAINT FK_AV_LOJA      FOREIGN KEY (fk_LOJA) REFERENCES LOJA(ID_Loja) ON DELETE CASCADE;

ALTER TABLE PROD_PTNC_CATG DROP CONSTRAINT FK_PTNC_PRODUTO;
ALTER TABLE PROD_PTNC_CATG ADD  CONSTRAINT FK_PTNC_PRODUTO FOREIGN KEY (fk_PRODUTO) REFERENCES PRODUTO(Prod_ID) ON DELETE CASCADE;

ALTER TABLE PROD_COMP_PEDD DROP CONSTRAINT FK_COMP_PRODUTO;
ALTER TABLE PROD_COMP_PEDD ADD  CONSTRAINT FK_COMP_PRODUTO FOREIGN KEY (fk_PRODUTO) REFERENCES PRODUTO(Prod_ID) ON DELETE CASCADE;

ALTER TABLE WL_ARMZ_PROD   DROP CONSTRAINT FK_ARMZ_PRODUTO;
ALTER TABLE WL_ARMZ_PROD   ADD  CONSTRAINT FK_ARMZ_PRODUTO FOREIGN KEY (fk_PRODUTO) REFERENCES PRODUTO(Prod_ID) ON DELETE CASCADE;
